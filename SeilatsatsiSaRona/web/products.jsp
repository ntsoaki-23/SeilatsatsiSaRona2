...
<body>
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="${pageContext.request.contextPath}/products" class="menu-item active"><i class="fas fa-box"></i><span>Products</span></a>
    ...
    <div class="main-content">
        <div class="top-bar">
            <div class="page-title"><h1>Product Catalog</h1></div>
        ...
        <div class="orders-table-container">
            <div class="table-header">
                <h3>Products</h3>
                <button class="btn-add" onclick="openAddProductModal()"><i class="fas fa-plus"></i> Add Product</button>
            </div>
            ...
            <div style="overflow-x: auto;">
                <table>
                    <thead>
                        <tr><th>ID</th><th>Product Name</th><th>Supplier</th><th>Cost (M)</th><th>Selling (M)</th><th>Profit (M)</th><th>Action</th></tr>
                    </thead>
                    <tbody>
                        ...
                        %>
                            <tr>
                                ...
                                <td>M <%= product.getSupplierPrice() %></td>
                                <td>M <%= product.getSellingPrice() %>\n
                                <td class="profit-positive">M <%= String.format("%.2f", profit) %></td>
                                <td><a href="${pageContext.request.contextPath}/products?action=delete&productId=<%= product.getProductId() %>" onclick="return confirm('Delete this product?')" class="btn-delete">Delete</a></td>
                            </tr>
                        <% } 
                        } else { %>
        ...
        <div class="modal-content">
            ...
            <form action="${pageContext.request.contextPath}/products" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="supplierPrice" step="0.01" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="category" placeholder="e.g., Clothing, Electronics">
                </div>
